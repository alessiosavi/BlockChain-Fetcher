...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		// La classe FetchAPI ha un costruttore che inizializza i parametri della
		// chiamata GET HTTP,
		...
		/*
		 * L'oggetto JSON verrà dato in pasto al costruttore, che provvederà a
		 * instanziare la classe Blocco con tutti i parametri.
		 */
